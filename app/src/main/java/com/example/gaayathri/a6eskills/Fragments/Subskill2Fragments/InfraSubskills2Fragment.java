 ...
 */
public class InfraSubskills2Fragment extends Fragment {
    ...
    public InfraSubskills2Fragment() {
    }
    ...
    private void loadListView(View view) {
        ...
        arrayList.add("Sys Admin - Linux");
        arrayList.add("Sys Admin - Windows");
        arrayList.add("Database Admin - Oracle");
        arrayList.add("Database Admin - DB/2");
        arrayList.add("Database Admin - MySQL");
        arrayList.add("Database Admin - SQLServer");
        arrayList.add("AppServer Admin - Oracle Weblogic");
        arrayList.add("AppServer Admin - Websphere");
        arrayList.add("AppServer Admin - JBOSS");
        arrayList.add("Firewalls, Vulnerability, Web Monitoring");
        arrayList.add("Digital Identity Management - ForgeRock");
        arrayList.add("Digital Identity Management - Oracle");
        arrayList.add("Digital Identity Management - Ping Identity");
        arrayList.add("Digital Rights Management - Amazon DRM");
        arrayList.add("Digital Rights Management - Apple Fairplay");
        arrayList.add("Digital Rights Management - Adobe ADEPT");
