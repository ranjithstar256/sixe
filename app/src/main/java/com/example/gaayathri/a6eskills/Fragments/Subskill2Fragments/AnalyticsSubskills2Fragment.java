 ...
 */
public class AnalyticsSubskills2Fragment extends Fragment {
    ...
    public AnalyticsSubskills2Fragment() {
    }
    ...
    private void loadListView(View view) {
        ...
        arrayList.add("Oracle BI");
        arrayList.add("SAP BI");
        arrayList.add("Tableau");
        arrayList.add("Qlikview");
        arrayList.add("R");
        arrayList.add("Microsoft SSIS/SSAS/SSRS");
