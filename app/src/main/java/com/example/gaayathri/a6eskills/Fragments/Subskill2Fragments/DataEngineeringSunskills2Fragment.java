 ...
 */
public class DataEngineeringSunskills2Fragment extends Fragment {
    ...
    public DataEngineeringSunskills2Fragment() {
    }
    ...
    private void loadListView(View view) {
        ...
        arrayList.add("Dimensional Modeling");
        arrayList.add("Platforms - RedShift/AWS/Linux/Jenkins");
        arrayList.add("Platforms - SQLServer/Azure");
        arrayList.add("Platforms - Python");
        arrayList.add("API Creation to input/export data");
        arrayList.add("DevOps background");
        arrayList.add("Visualization Experience");
        arrayList.add("Data Warehousing - Informatica");
        arrayList.add("Data Warehousing - Ab Initio");
        arrayList.add("Data Warehousing - Data Stage");
