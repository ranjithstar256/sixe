 ...
 */
public class DevopsSubskills2Fragment extends Fragment {
    ...
    public DevopsSubskills2Fragment() {
    }
    ...
    private void loadListView(View view) {
        ...
        arrayList.add("Java / AWS");
        arrayList.add(".NET / Azure");
        arrayList.add("Pivotal Cloud Foundry");
        arrayList.add("MEAN ( AngJs)");
        arrayList.add("MERN ( ReactJs)");
